...
export class UniversidadController {
  ...
  @Get('peticion-1')
  async consultarPeticion1(): Promise<RespuestaCarrerasConMaterias> { // Funcion Asíncrona #2
    return await this.universidadService.consultarCarrerasConMaterias();
  }

  @Post('peticion-2')
  async crearPeticion2( // Funcion Asíncrona #3
    ...
    return await this.universidadService.crearPeticion2({
      Ciclo, Carrera, Estudiantes, Matricula,
    });
  }

  @Get('peticion-2')
  async consultarPeticion2(): Promise<RespuestaMatriculasActivas> { // Funcion Asíncrona #4
    return await this.universidadService.consultarMatriculasActivas();
  }

  @Post('peticion-3')
  async crearPeticion3( // Funcion Asíncrona #5
    ...
    return await this.universidadService.crearPeticion3({
      Laboratorio, Ciclo, Matricula, Materia,
    });
  }

  @Get('consultas/carreras-con-materias')
  async consultarCarrerasConMaterias(): Promise<RespuestaCarrerasConMaterias> { // Funcion Asíncrona #6
    return await this.universidadService.consultarCarrerasConMaterias();
  }

  @Get('consultas/matriculas-activas')
  async consultarMatriculasActivas(): Promise<RespuestaMatriculasActivas> { // Funcion Asíncrona #7
    return await this.universidadService.consultarMatriculasActivas();
  }
}
